...
|---------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------|---------------------------------------------------|----------------------------------------------|
| <img src="[https://github.com/Avishek2020/credit-card-fraud-detection/blob/main/image/credit-card.png](https://raw.githubusercontent.com/Avishek2020/rag-with-guardrails-and-eval/refs/heads/main/agentic_rag_dashboard.png)" alt=" credit card" width="230"/> **Agentic RAG System (Guardrails + Evaluation)** | Built an end-to-end Agentic RAG system with FAISS-based retrieval, guardrails for AI safety, and evaluation metrics, deployed via a Streamlit dashboard.  | Python, openai, faiss | [Repo](https://github.com/Avishek2020/rag-with-guardrails-and-eval) |
